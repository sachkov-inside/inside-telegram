...
В существующем общем лимите 40 ms на bot и 1 s на chat каждые четыре интервала выделены так:
два — subscription, один — material, один — существующие служебные/marketing сообщения.
Свободные notification интервалы заимствуются другими отправителями. Категории не создают новых
